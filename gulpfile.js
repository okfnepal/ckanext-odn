...
gulp.task('sass', function () {
  return gulp.src('ckanext/oknp/fanstatic/sass/**/*.scss')
    .pipe(sass({
         outputStyle : 'compressed'
      }).on('error', sass.logError))
    .pipe(gulp.dest('ckanext/oknp/fanstatic/css'))
...
gulp.task('less', function () {
  return gulp.src('ckanext/oknp/fanstatic/css/less/main.less') 
...
gulp.task('watch', function () {
  gulp.watch(['ckanext/oknp/fanstatic/less/**/*.less'], gulp.parallel('less'));
  gulp.watch(['ckanext/oknp/fanstatic/sass/**/*.scss'], gulp.parallel('sass'));
});
